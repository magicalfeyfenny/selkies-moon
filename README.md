...
Controls:
Menus: Up/Down/Left/Right navigates, X to go back, Z to select
Gameplay: Up/Down/Left/Right moves, Z (tap) fires a volley of shots, Z (hold) swings a bullet cancelling sword, X uses a Bomb and cancels all bullets, C (hold) autofires the volley of shots that Z (tap) fires
