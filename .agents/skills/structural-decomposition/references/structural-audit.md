...
5. Choose one independently reviewable responsibility cluster. Define its narrow interface, expected callers, validation, review risk, and a stop point before editing.

Keep the audit in the task or handoff; update architecture ownership only once the result is durable. Record the current owner, proposed future owner, characterization prerequisite, and extraction scope separately.
