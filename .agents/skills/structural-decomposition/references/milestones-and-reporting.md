...
- Update `docs/ARCHITECTURE.md`, module mapping, `docs/PROJECT_STATE.md`, or a handoff only when a durable ownership, supported-state, or continuity fact changed. Follow `docs/HANDOFF_TEMPLATE.md` for an interrupted non-obvious state, and `docs/AGENT_REVIEW_POLICY.md` before calling a pull request reviewed or ready.
